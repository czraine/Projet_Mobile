...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsButton.setOnClickListener(view -> {
            Toast.makeText(MainActivity.this, "Navigating to Display Item Post...", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(MainActivity.this, DisplayPostsActivity.class); // Ensure DisplayPostsActivity is the correct class
    ...
    private void initRecyclerView() {
        ...
        items.add(new PopularDomain("Mar caible, avendia lago", "Miami Beach", "This 2 bed /1 bath home boasts an enormous, open-living plan...", 2, true, 4.8, "pic1", true, 1000));
        items.add(new PopularDomain("Passo Rolle, TN", "Hawaii Beach", "This 2 bed /1 bath home boasts an enormous, open-living plan...", 1, false, 5, "pic2", false, 2500));
        items.add(new PopularDomain("Mar caible, avendia lago", "Miami Beach", "This 2 bed /1 bath home boasts an enormous, open-living plan...", 3, true, 4.3, "pic3", true, 30000));
